...
def main():
    ...
    analyze_structure(dom)
    print('{} extracted {} concepts and {} concepts with relations to other concepts'
    .format(datetime.now() - startTime, len(full_list_of_concepts), len(scheme_values)))
