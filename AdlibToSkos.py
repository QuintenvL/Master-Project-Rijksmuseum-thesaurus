...
print('{} started script'.format(datetime.now() - startTime))
...
copyfile(source_file, transformed_file)
# Start a run over the file to create list and dictionaries
dom = parse(transformed_file)
...
print('{} extracted {} concepts'.format(datetime.now() - startTime, len(full_list_of_concepts)))
print('{} extracted {} concepts with relation to other concepts'.format(datetime.now() - startTime, len(hierarchy_dict)))
...
print('{} added {} concept schemes to {}'.format(datetime.now() - startTime, len(scheme_values), transformed_file))
...
b_file.close()
print('{} wrote {} concepts without concept scheme to {}'.format(datetime.now() - startTime, len(typeless_concepts), missing_file))
